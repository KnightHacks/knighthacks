        ...
        <div className="mb-4 space-x-2 space-y-2">
          <Card>
            <CardHeader>
              ...
              <div className="text-md flex flex-row space-x-1 text-gray-500">
                ...
                <div>Confirmed Plinkterns: {counts.plinktern_confirmed}</div>
          ...
          <Tabs defaultValue="view">
            ...
            <TabsContent value="waitlist">
              <WaitlistTable updateCounts={setCounts} />
            </TabsContent>
          </Tabs>
        </div>
      </div>
...
export function WaitlistTable({ updateCounts }: TableProps) {
  const { data: hackers, isPending, error } = api.hacker.adminAll.useQuery();
  ...
  const waitlistedCount = allHackers?.length;
  ...
  return (
    <div className="flex h-full">
      <Card className="mr-4 w-1/4">
        <CardHeader>
          <CardTitle>Waitlist Hackers</CardTitle>
          <div className="text-sm text-gray-500">
            Accepted Remaining: {waitlistedCount}
          </div>
        </CardHeader>
        <CardContent className="p-0">
          <ScrollArea className="h-full">
